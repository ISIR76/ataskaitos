...
class ProjectRepository:
    ...
    async def create(self, name: str, project_type: str, user_id: int) -> Project:
    ...
    async def get_by_id(self, project_id: int, load_versions: bool = False) -> Project | None:
        """Get project by ID.
    ...
    async def list_by_user(self, user_id: int, skip: int = 0, limit: int = 100) -> list[Project]:
